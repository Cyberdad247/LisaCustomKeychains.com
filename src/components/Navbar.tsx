        ...
        <div className="max-w-7xl mx-auto px-6 h-full">
          <div className={`flex items-center h-full transition-all duration-700 relative ${isScrolled ? 'justify-between' : 'flex-col justify-center'
            ...
            >
              ...
              <a href="/sports" className="hover:text-purple-700 transition-colors" aria-label="Sports Collection">SPORTS</a>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            <a href="/sports" className="hover:text-purple-700 transition-colors" onClick={() => setIsMobileMenuOpen(false)}>SPORTS</a>
