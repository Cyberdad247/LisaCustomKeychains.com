...
export default function DevPortal() {
  ...
  const logs = [
    { id: 1, action: 'CUSTOMIZATION_RULE_UPDATE', node: 'Merlin', result: 'Verified', details: 'Limit: 8-char, Palette: 16+Rainbow', time: 'Just now' },
    { id: 2, action: 'OCTAVIAN_PROTOCOL_AUDIT', node: 'Zenith', result: 'Verified', details: 'Full Directory Performance & Security Reset', time: '8m ago' },
    { id: 3, action: 'TIER_PROTOCOL_ACK', node: 'Merlin', result: 'Verified', details: 'Mapped $2.95/$5.95/$9.95 Tiers', time: '12m ago' },
    { id: 4, action: 'PALETTE_EXPANSION_12', node: 'Syntax', result: 'Success', details: 'Injected 12 Signature Yarn Colors', time: '18m ago' },
